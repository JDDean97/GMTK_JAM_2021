...
public class cameraSmoother : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector2 p1pos = Camera.main.WorldToViewportPoint(climbers[0].transform.position);
        Vector2 p2pos = Camera.main.WorldToViewportPoint(climbers[1].transform.position);
